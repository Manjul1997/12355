...
<body>
<h1> PRIVACY AND POLICY</h1><br><br>
<article>
<p>Thanks for visiting website of NEW WAY OF FINDING FITURE and reviewing our privacy policy.
...
<p>The type of browser (such as Firefox, google chrome or Internet Explorer) and operating system (Windows, Linux) used to access our site .
	<p>The date and time you accessed our site.</p>
<p>	The pages/URLs you have visited and</p>
<p>	If you reached this website from another website, the address of that referring website.</p>
                 
<p>This information is only used to help us make the site more useful for you. With this data, we learn about the number of visitors to our site and the types of technology our visitors use. We never track or record information about individuals and their visits.
...
<h4><mark> SECURITY SITE</mark> </h4>
<p>For site security purposes and to ensure that this service vice remains available to all users, this Government computer system employs commercial software programs to monitor network traffic to identify unauthorised attempts to upload or change information, or otherwise cause damage.</p>
<h6>Except for authorised law enforcement investigations, no other attempts are made to identify individual users or their usage habits. Raw data logs are used for no other purposes and are scheduled for regular deletion.
<br>	Unauthorised attempts to upload information or change information on this service are strictly prohibited and may be punishable under the Indian IT Act.
</h6>
